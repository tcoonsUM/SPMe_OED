...
if __name__ == '__main__':    
    ...
    utilities = ute.eig_mp(d_test, 5000, 5000, rel_std, clusters_inds_npz, corrs_clustered_npz)
    stop_time = time.time()
    dur = stop_time-start_time
    print(utilities.mean())
    print(utilities.var()/5000)
    print(dur)
...
llh2 = ute.eval_log_likelihood_mvn(y_test_np[0,:]+test, y_test_np[0,:], test_cov)
...
print(f"Time taken for eval_log_likelihood_mvn: {time_llh2} seconds")
