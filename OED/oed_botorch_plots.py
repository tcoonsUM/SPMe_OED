...
if __name__ == "__main__":
    ...
    train_X_unscaled_legacy = torch.cat((torch.load("train_X_unscaled_6e3.pt"),torch.load("train_X_unscaled_cont.pt")),dim=0)
    train_Y_unscaled_legacy = torch.cat((torch.load("train_Y_unscaled_legacy_dur.pt"),torch.load("train_Y_unscaled_cont.pt")),dim=0)
